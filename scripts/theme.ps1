...
.DESCRIPTION
  ...
  the terminal. Real logic lives in dotfiles/dot_config/powershell/Modules/Taminaru.Theme/
...
$Module = Join-Path $PSScriptRoot "../dotfiles/dot_config/powershell/Modules/Taminaru.Theme/Taminaru.Theme.psm1"
