...
* [x] dotfile installer
  * [x] scripts/bootstrap.ps1 (symlinks config/* -> ~/.config/*, wires mise + theme)
  * [x] mise.toml + mise.lock for the whole toolchain
* [x] switch from winget to scoop or chocolatey
  * [x] superseded: mise for CLI tools, winget kept for Windows GUI
